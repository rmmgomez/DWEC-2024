...
import {
  ...
  fromResolutionLike,
  render
} from "./chunk-MO5OCODC.js";
import {
  TileQueue_default,
  VectorRenderTile_default,
  VectorTile_default
} from "./chunk-YJHQWZU2.js";
import {
  DEFAULT_MAX_ZOOM,
  DEFAULT_TILE_SIZE,
  Feature_default,
  ...
  loadFeaturesXhr,
  withinExtentAndZ
} from "./chunk-BHYNVLUF.js";
import {
  Point_default,
  create,
  intersectsLinearRing
} from "./chunk-DFMWDHLH.js";
import {
  ImageState_default,
  Image_default,
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-LCBX2PLF.js").then((module) => {
